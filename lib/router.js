...
// 重庆市人力社保局-事业单位招考
router.get('/gov/chongqing/rlsbj/sydw', lazyloadRouteHandler('./routes/gov/chongqing/rlsbj/sydw'));
// 重庆市人力社保局-事业单位及其他考试
router.get('/gov/chongqing/rlsbj/sydwks', lazyloadRouteHandler('./routes/gov/chongqing/rlsbj/sydwks'));
// 重庆市人力社保局-事业单位通知公告
router.get('/gov/chongqing/rlsbj/tzgg', lazyloadRouteHandler('./routes/gov/chongqing/rlsbj/tzgg'));
// 重庆市人力社保局-公示信息
router.get('/gov/chongqing/rlsbj/gsxx', lazyloadRouteHandler('./routes/gov/chongqing/rlsbj/gsxx'));
router.get('/gov/chongqing/rlsbj/gqzp', lazyloadRouteHandler('./routes/gov/chongqing/rlsbj/gqzp'));

// 重庆市梁平区人力社保局招考
router.get('/gov/chongqing/rlsbj/lpzk', lazyloadRouteHandler('./routes/gov/chongqing/rlsbj/lpzk'));

// 重庆市公考雷达
router.get('/gov/chongqing/gkld', lazyloadRouteHandler('./routes/gov/chongqing/gkld'));
router.get('/gov/chongqing/gkld', lazyloadRouteHandler('./routes/gov/chongqing/gkld1'));
router.get('/gov/chongqing/gkld', lazyloadRouteHandler('./routes/gov/chongqing/gkld2'));
router.get('/gov/chongqing/gkld', lazyloadRouteHandler('./routes/gov/chongqing/gkld3'));
router.get('/gov/chongqing/gkld', lazyloadRouteHandler('./routes/gov/chongqing/gkld4'));
router.get('/gov/chongqing/gkld', lazyloadRouteHandler('./routes/gov/chongqing/gkld5'));
router.get('/gov/chongqing/gkld', lazyloadRouteHandler('./routes/gov/chongqing/gkld6'));

// 重庆市粉笔网
router.get('/gov/chongqing/fenbi', lazyloadRouteHandler('./routes/gov/chongqing/fenbi'));
